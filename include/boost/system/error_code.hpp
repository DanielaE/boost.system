...
public:
    ...
    BOOST_SYSTEM_DECL std::string message( int ev ) const;
};
...
public:
    ...
    BOOST_SYSTEM_DECL std::string message( int ev ) const;
    BOOST_SYSTEM_DECL error_condition default_error_condition( int ev ) const BOOST_SYSTEM_NOEXCEPT;
};
...
#elif defined(BOOST_ERROR_CODE_HEADER_ONLY)
